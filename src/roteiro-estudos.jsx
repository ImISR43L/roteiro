...
const R = {
  "Jun/26": {
    phase: "efomm",
    milestones: [
      "⚠️ EFOMM em ~66 dias — SPRINT ATIVO",
      "📋 Resolver provas EFOMM dos últimos 3 anos",
    ...
    subjects: {
      japanese: {
        ...
        notes:
          "06:10 todo dia, sem exceção. Única matéria sem cobertura no cursinho.",
        topics: [
          "Finalizar colunas Ra, Wa, N do Hiragana",
          "Diacríticos e sons combinados (きゃ, しゅ…)",
          "Katakana — colunas A, Ka, Sa, Ta, Na",
          "Revisão Anki diária de todos os kana",
          "Escuta passiva: 10 min de áudio simples/dia",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Iezzi Vol.1", "Japa Math", "Provas EFOMM"],
        notes:
          "Antes de cada fórmula, escreva o que ela descreve. Quebre o mecanicismo.",
        topics: [
          "Mat IV — Trigonometria: seno, cosseno, tangente no triângulo retângulo",
          "Mat IV — Relações métricas e tabela de valores especiais",
          "Mat III — Progressões Aritméticas: fórmulas e soma de termos",
          "Mat III — Progressões Geométricas: fórmulas e soma",
          "Mat I — Revisão de funções afim e quadrática",
          "Resolver provas EFOMM — seção Matemática (2 anos)",
        ],
      },
      physics: {
        priority: "alta",
        resources: ["Tópicos de Física Vol.1", "Guisolli"],
        notes: "Assista Guisolli ANTES dos exercícios.",
        topics: [
          "Fís I — Cinemática Escalar: MRU e MRUV (reconstruir com raciocínio)",
          "Fís I — Gráficos de movimento: leitura e construção",
          "Fís I — Queda livre e lançamento vertical",
          "Fís I — Cinemática Vetorial: lançamento oblíquo",
          "Fís I — Dinâmica: Leis de Newton",
          "Resolver provas EFOMM — seção Física (2 anos)",
        ],
      },
      chemistry: {
        priority: "alta",
        resources: ["Feltre Vol.1"],
        notes: "Do zero. Leia o texto ANTES de qualquer exercício.",
        topics: [
          "Qui I — Estrutura atômica: prótons, nêutrons, elétrons",
          "Qui I — Modelos atômicos: Dalton → Bohr",
          "Qui I — Tabela Periódica: grupos, períodos, propriedades",
          "Qui I — Ligações químicas: iônica, covalente, metálica",
        ],
      },
      english: {
        priority: "média",
        ...
        notes: "",
        topics: [
          "Analisar formato das questões EFOMM (leitura + gramática)",
          "Passive voice, conditionals, modals — revisão",
          "Vocabulário técnico científico em inglês",
        ],
      },
      portuguese: {
        priority: "média",
        ...
        notes: "",
        topics: [
          "1 texto/dia para interpretação (10 min)",
          "Tipos textuais e gêneros discursivos",
          "Resolver seção Português de 2 provas EFOMM",
        ],
      },
    },
  },
  "Jul/26": {
    phase: "efomm",
    milestones: [
      "🎯 EFOMM — 25 e 26 de julho",
      "📊 Simulado EFOMM completo cronometrado — semana 1",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Tofugu Katakana", "Anki"],
        notes:
          "EFOMM não testa japonês — mantenha o ritmo matinal, não intensifique.",
        topics: [
          "Katakana: colunas Ha, Ma, Ya, Ra, Wa, N",
          "Diacríticos e sons combinados do Katakana",
          "Leitura de estrangeirismos em Katakana",
          "Revisão Anki: Hiragana + Katakana completos",
        ],
      },
      math: {
        priority: "crítica",
        ...
        notes:
          "Semana pré-prova: revisão leve. Nenhum tópico novo nos últimos 4 dias.",
        topics: [
          "Mat III — Análise Combinatória: permutação, arranjo, combinação",
          "Mat III — Probabilidade: espaço amostral, eventos",
          "Mat V — Geometria Plana: áreas e relações métricas",
          "Mat I — Matrizes: operações e determinante 2×2",
          "Resolver 3 provas EFOMM de Matemática (cronometradas)",
        ],
      },
      physics: {
        priority: "crítica",
        ...
        notes: "",
        topics: [
          "Fís I — Trabalho, energia cinética, potencial — conservação",
          "Fís II — Termometria: escalas e conversões",
          "Fís IV — Óptica Geométrica: reflexão e espelhos planos",
          "Resolver 3 provas EFOMM de Física (cronometradas)",
          "Revisão dos pontos fracos do simulado da semana 1",
        ],
      },
      chemistry: {
        priority: "crítica",
        resources: ["Feltre Vol.1", "Provas EFOMM"],
        notes: "Funções inorgânicas são muito cobradas no EFOMM.",
        topics: [
          "Qui I — Funções inorgânicas: ácidos e bases",
          "Qui I — Sais e óxidos: classificação e nomenclatura",
          "Qui II — Estequiometria básica: mol e massa molar",
          "Resolver provas EFOMM de Química",
        ],
      },
      english: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Resolver seção inglês de 3 provas EFOMM (cronometradas)",
          "Revisar erros: estruturas gramaticais específicas",
        ],
      },
      portuguese: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Resolver seção português de 3 provas EFOMM",
          "Ortografia e concordância — pontos que errou",
        ],
      },
    },
  },
  "Ago/26": {
    phase: "enem",
    milestones: [
      "📊 Simulado ENEM completo (diagnóstico)",
      "📋 Conferir resultado EFOMM",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Genki I cap.1-4", "Anki N5"],
        notes: "Com EFOMM concluído, japonês ganha mais espaço.",
        topics: [
          "Consolidar Katakana: leitura fluente",
          "Vocabulário N5: 300 palavras (números, cores, verbos)",
          "Partículas は, が, を, に, で — diferenças de uso",
          "Primeiras frases simples em japonês",
          "Escuta: NHK for School (vídeos curtos)",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Iezzi Vol.3", "Dicas do Lipe"],
        notes: "Geometria é ponto nulo — atenção dobrada.",
        topics: [
          "Mat V — Geometria Plana: áreas, semelhança, Tales",
          "Mat V — Geometria Espacial: prismas e pirâmides",
          "Mat I — Logaritmos: propriedades e equações",
          "Mat IV — Trigonometria: identidades e equações simples",
        ],
      },
      physics: {
        priority: "alta",
        resources: ["Tópicos de Física Vol.1", "Guisolli"],
        notes: "Eletrostática é ponto nulo — comece a construção agora.",
        topics: [
          "Fís II — Termologia: dilatação, calorimetria, fases",
          "Fís II — Termodinâmica: leis e ciclos (conceitual)",
          "Fís IV — Óptica Geométrica completa: lentes e olho humano",
          "Fís III — Eletrostática: cargas, Coulomb, campo elétrico",
        ],
      },
      chemistry: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Qui I — Reações químicas: tipos e balanceamento",
          "Qui II — Soluções: concentração comum e molar",
          "Qui II — Estequiometria: reagente limitante e rendimento",
        ],
      },
      biology: {
        priority: "média",
        resources: ["Descomplica", "Khan Academy Brasil"],
        notes: "30-40 min nos domingos.",
        topics: [
          "Citologia: estrutura e funções das organelas",
      ...
      portuguese: {
        priority: "média",
        resources: ["Cursinho", "Redação online"],
        notes: "Comece a treinar redação agora. Nota 900 exige repetição.",
        topics: [
          "Redação dissertativa-argumentativa: estrutura ENEM",
          "1ª redação completa + auto-revisão pelos critérios",
          "Variação linguística e recursos argumentativos",
        ],
      },
      humanities: {
        priority: "baixa",
        ...
        notes: "30 min/semana.",
        topics: [
          "Era Vargas e Ditadura Militar — resumo",
  ...
  "Set/26": {
    ...
    milestones: [
      ...
      "📋 Resolver provas ENEM — 5 anos anteriores (início)",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Genki I cap.5-9", "Anki N5", "NHK Web Easy"],
        notes: "Sprint ENEM não afeta as manhãs de japonês. Sem exceção.",
        topics: [
          "Vocabulário N5: completar 600 palavras",
          "Forma て dos verbos (grupos 1, 2, 3)",
          "Forma negativa, passado e negativo-passado",
          "Kanji introdutório: 日月火水木金土人口",
          "Leitura: frases simples no NHK Web Easy",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Iezzi Vol.5", "Provas ENEM"],
        notes: "Provas antigas são a melhor preparação. Analise CADA ERRO.",
        topics: [
          "Mat V — Geometria Espacial: cilindros, cones, esferas",
          "Mat III — Estatística: média, mediana, moda, desvio padrão",
          "Mat III — Análise Combinatória + probabilidade condicional",
          "Resolver provas ENEM de Matemática (3 anos)",
        ],
      },
      physics: {
        priority: "alta",
        resources: ["Tópicos de Física", "Provas ENEM"],
        notes: "",
        topics: [
          "Fís III — Eletrostática: potencial elétrico e energia",
          "Fís III — Eletrodinâmica: corrente, resistência, lei de Ohm",
          "Revisão orientada por provas: erros do simulado",
          "Resolver provas de Física ENEM (3 anos)",
        ],
      },
      chemistry: {
        priority: "alta",
        resources: ["Feltre Vol.1", "Provas ENEM"],
        notes: "",
        topics: [
          "Qui I — Revisão de funções inorgânicas com questões ENEM",
          "Qui IV — Orgânica básica: carbono, cadeias, hidrocarbonetos",
          "Resolver provas de Química ENEM (3 anos)",
        ],
      },
      biology: {
        priority: "média",
        resources: ["Descomplica", "Provas ENEM"],
        notes: "Aumentar para 1h nos domingos.",
        topics: [
          "Ecologia: biomas, ciclos biogeoquímicos",
          "Evolução: Darwin, neodarwinismo, especiação",
          "Genética molecular: DNA, RNA, síntese proteica",
        ],
      },
      portuguese: {
        priority: "alta",
        resources: ["Cursinho", "Provas ENEM"],
        notes: "Redação é a maior alavanca de nota no ENEM.",
        topics: [
          "2 redações/semana com revisão pelos critérios ENEM",
          "Literatura: romantismo, realismo, naturalismo",
          "Interpretação: textos multimodais e infográficos",
          "Questões de Linguagens de 3 ENEMs",
        ],
      },
      humanities: {
        priority: "média",
        resources: ["Apostila", "Provas ENEM"],
        notes: "",
        topics: [
          "Filosofia e Sociologia: conceitos cobrados no ENEM",
          "Questões de HU de 3 ENEMs anteriores",
        ],
      },
    },
  },
  "Out/26": {
    phase: "enem",
    milestones: [
      "📊 Simulado ENEM completo (1 por semana)",
      "📋 Lista pessoal de erros por matéria",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Genki I (finalizar)", "Anki N5"],
        notes: "",
        topics: [
          "Adjetivos i/na — forma predicativa e modificadora",
          "Existência: います / あります",
          "Expressões de tempo: 前に, 後で, とき",
          "Vocabulário N5: completar 800 palavras",
          "1 artigo NHK Web Easy por semana",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Provas ENEM", "Iezzi"],
        notes: "",
        topics: [
          "Revisão total pelos erros dos simulados anteriores",
          "Mat V — Geometria Espacial: exercícios contextualizados",
          "Resolver 3 provas ENEM de Matemática (cronometradas)",
        ],
      },
      physics: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Fís III — Circuitos elétricos: série e paralelo, potência",
          "Revisão via provas: focar nos erros dos simulados",
          "Resolver 3 provas de Física ENEM (cronometradas)",
        ],
      },
      chemistry: {
        priority: "alta",
        resources: ["Coiro (Orgânica)", "Provas ENEM"],
        notes: "",
        topics: [
          "Qui IV — Funções orgânicas: aldeídos, cetonas, ácidos, ésteres",
          "Qui IV — Polímeros e plásticos — contexto ENEM",
          "Revisão geral + 3 provas de Química ENEM",
        ],
      },
      biology: {
        priority: "média",
        ...
        notes: "",
        topics: [
          "Fisiologia humana: sistemas circulatório, respiratório, nervoso",
          "Imunologia: sistema imune e vacinas",
          "Questões de Biologia de 5 ENEMs",
        ],
      },
      portuguese: {
        priority: "alta",
        resources: ["Provas ENEM", "Cursinho"],
        notes: "",
        topics: [
          "2 redações/semana (manter ritmo)",
          "Modernismo: Semana de 22 e fases",
          "Gramática: crase, pontuação, regência",
          "Questões de Linguagens de 5 ENEMs",
        ],
      },
      humanities: {
        priority: "média",
        ...
        notes: "",
        topics: [
          "Resolver HU de 5 ENEMs — identificar tópicos frequentes",
          "Revisar os tópicos mais errados",
        ],
      },
    },
  },
  "Nov/26": {
    phase: "enem",
    milestones: [
      "🎯 ENEM — 8 de novembro (Linguagens + Humanas + Redação)",
      "🎯 ENEM — 15 de novembro (Ciências da Natureza + Matemática)",
      "📋 SISU: verificar datas de inscrição",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Genki I (revisão)", "Anki"],
        notes:
          "Após o ENEM (16/nov), a rotina muda radicalmente. Japonês passa a protagonista.",
        topics: [
          "Pré-ENEM: manter ritmo matinal sem interrupção",
          "Revisão de gramática N5 acumulada",
          "Após ENEM (16/nov): aumentar para 1h30 matinal",
          "Após ENEM: iniciar vocabulário N4 (100 palavras/semana)",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Provas ENEM", "Iezzi Vol.6"],
        notes: "",
        topics: [
          "Pré-ENEM: revisão leve das 5 frentes com mais erros",
          "Descanso nos 2 dias anteriores a cada dia",
          "Após ENEM: Mat II — Polinômios (Iezzi Vol.6, ponto nulo)",
          "Após ENEM: Mat II — Números Complexos — forma algébrica",
        ],
      },
      physics: {
        priority: "alta",
        resources: ["Provas ENEM", "Tópicos de Física"],
        notes: "",
        topics: [
          "Pré-ENEM: revisão leve de conceitos e fórmulas-chave",
          "Após ENEM: Fís III — Magnetismo — campo, Lorentz, indução",
        ],
      },
      chemistry: {
        priority: "alta",
        resources: ["Provas ENEM", "Coiro"],
        notes: "",
        topics: [
          "Pré-ENEM: revisão leve de Qui I e Qui IV",
          "Após ENEM: Qui IV — Orgânica aprofundada — isomeria",
        ],
      },
      biology: {
        priority: "baixa",
        resources: [],
        notes: "Após o ENEM, Biologia sai completamente do foco.",
        topics: [
          "Pré-ENEM: revisão final leve",
          "Após ENEM: encerrar estudo de Biologia",
        ],
      },
      portuguese: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Reler 2-3 redações anteriores — identificar padrões de erro",
          "1 redação de treino 3 dias antes de cada dia de prova",
          "Após ENEM: Português para EFOMM (gramática formal)",
        ],
      },
      humanities: {
        priority: "baixa",
        resources: [],
        notes: "Após o ENEM, Humanas sai completamente do foco.",
        topics: [
          "Revisão leve — nada de novo",
          "Após ENEM: encerrar estudo de Humanas",
        ],
      },
    },
  },
  "Dez/26": {
    ...
    milestones: [
      ...
      "📋 SISU — inscrições (~janeiro/27)",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Genki I finalizar", "Anki N4", "NHK Web Easy"],
        notes: "Com ENEM concluído, japonês divide protagonismo com Exatas.",
        topics: [
          "Gramática N5: revisão completa de todas as estruturas",
          "Vocabulário N4: primeiras 200 palavras",
          "Kanji N5: completar lista de 80 (5/semana)",
          "1 artigo NHK Web Easy por dia + anotações",
          "Primeiro simulado JLPT N5 (diagnóstico)",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Iezzi Vol.6", "Iezzi Vol.3"],
        notes: "",
        topics: [
          "Mat II — Polinômios: operações, divisão, teorema do resto",
          "Mat II — Raízes, fatoração e relações de Girard",
          "Mat II — Números Complexos: módulo, argumento, conjugado",
          "Mat V — Geometria Espacial: sólidos de revolução",
        ],
      },
      physics: {
        priority: "alta",
        resources: ["Tópicos de Física Vol.1"],
        notes: "Magnetismo é essencial para MEXT e EFOMM.",
        topics: [
          "Fís III — Magnetismo: campo, linhas de campo, força sobre corrente",
          "Fís III — Força de Lorentz: força sobre carga em movimento",
          "Fís III — Indução Eletromagnética: lei de Faraday e Lenz",
          "Fís III — Geradores e motores: funcionamento básico",
        ],
      },
      chemistry: {
        priority: "alta",
        resources: ["Coiro (Orgânica)", "Feltre"],
        notes: "",
        topics: [
          "Qui IV — Funções orgânicas: aminas, amidas, haletos",
          "Qui IV — Isomeria plana: cadeia, posição, função",
          "Qui IV — Isomeria espacial: cis/trans (conceitual)",
          "Qui IV — Polímeros: adição e condensação",
        ],
      },
      english: {
        priority: "média",
        resources: ["Artigos científicos em inglês"],
        notes: "",
        topics: [
          "1 artigo de divulgação científica em inglês/semana",
          "Vocabulário técnico para contexto MEXT",
        ],
      },
    },
  },
  "Jan/27": {
    ...
    milestones: [
      ...
      "📋 Verificar resultado EFOMM e chamadas",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Genki II início", "Anki N4", "NHK Web Easy"],
        notes: "",
        topics: [
          "Gramática N4: ている — estado vs. ação em progresso",
          "Forma condicional たら — uso principal",
          "Vocabulário N4: completar 400 palavras",
          "Kanji N4: iniciar (300 kanji — 10/semana)",
          "Primeiro simulado JLPT N4 (diagnóstico)",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Iezzi Vol.4"],
        notes: "Geometria Analítica é muito cobrada na MEXT.",
        topics: [
          "Mat IV — Geometria Analítica: ponto, distância, ponto médio",
          "Mat IV — Retas: equação geral, coeficiente angular, posições",
          "Mat IV — Distância de ponto a reta",
          "Mat I — Sistemas lineares: escalonamento e Cramer",
          "Mat I — Matrizes: inversa, determinante 3×3",
        ],
      },
      physics: {
        priority: "alta",
        resources: ["Tópicos de Física Vol.1", "Guisolli"],
        notes: "Física Moderna é negligenciada em cursinhos — aparece na MEXT.",
        topics: [
          "Fís II — Ondas: classificação, comprimento, frequência",
          "Fís II — Acústica: características do som",
          "Fís IV — Física Moderna: quantização de energia (início)",
        ],
      },
      chemistry: {
        priority: "alta",
        resources: ["Feltre cinética + equilíbrio"],
        notes: "Cinética e equilíbrio são muito cobrados na MEXT.",
        topics: [
          "Qui III — Cinética química: velocidade e fatores",
          "Qui III — Lei da velocidade e ordem de reação (conceitual)",
          "Qui III — Equilíbrio químico: Kc e Kp",
          "Qui III — Princípio de Le Chatelier",
        ],
      },
      english: {
        priority: "média",
        resources: ["Past papers MEXT"],
        notes: "",
        topics: [
          "Iniciar provas MEXT em inglês: analisar formato",
          "Leitura técnica: artigos de física e química",
        ],
      },
    },
  },
  "Fev/27": {
    phase: "base",
    milestones: ["📊 Simulado completo MEXT (prova inteira cronometrada)"],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Genki II", "Anki N4", "Shadowing Japanese"],
        notes: "",
        topics: [
          "Gramática N4: formas condicionais ば e なら",
          "Voz passiva — forma e contextos",
          "Voz causativa básica",
          "Vocabulário N4: completar 600 palavras",
          "Compreensão auditiva N4: JapanesePod101",
          "Simulado JLPT N4: identificar pontos fracos",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Iezzi Vol.4", "Provas MEXT"],
        notes: "O estilo MEXT é diferente do ENEM — requer adaptação.",
        topics: [
          "Mat IV — GA: circunferência — equação e posição relativa",
          "Mat IV — Cônicas: elipse (definição, focos, excentricidade)",
          "Mat II — Números Complexos: forma trigonométrica, De Moivre",
          "Primeiras provas MEXT de Matemática: analisar estilo",
        ],
      },
      physics: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Fís IV — Efeito fotoelétrico: equação de Einstein",
          "Fís IV — Bohr: espectros atômicos e estados de energia",
          "Fís IV — Dualidade onda-partícula (de Broglie)",
          "Fís IV — Relatividade restrita: dilatação do tempo (conceitual)",
          "Primeiras provas MEXT de Física: analisar formato",
        ],
      },
      chemistry: {
        priority: "alta",
        resources: ["Feltre", "Provas MEXT"],
        notes: "Radioatividade é muito cobrada na MEXT.",
        topics: [
          "Qui III — Eletroquímica: pilhas galvânicas, potencial de redução",
          "Qui III — Eletrólise: ígnea e aquosa, lei de Faraday",
          "Qui III — Radioatividade: emissão alfa, beta, gama e meia-vida",
          "Primeiras provas MEXT de Química: analisar formato",
        ],
      },
    },
  },
  "Mar/27": {
    phase: "prep",
    milestones: ["📊 Simulado completo MEXT (cronometrado + análise de erros)"],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Provas MEXT", "Anki N4", "Shadowing"],
        notes:
          "A prova tem 3 seções: vocabulário/kanji, gramática e leitura. Treine separadamente.",
        topics: [
          "Gramática N4: concessão ても e のに",
          "Gramática N4: propósito ために e ように",
          "Vocabulário N4: completar 800 palavras",
          "Kanji N4: 150 kanji completados",
          "Simulados semanais estilo MEXT",
          "Escrita: parágrafos sobre temas cotidianos",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Provas MEXT", "Material de Cálculo"],
        notes: "Cálculo pode aparecer dependendo da área declarada.",
        topics: [
          "Mat IV — Limites: conceito informal e cálculo algébrico",
          "Mat IV — Derivadas: definição por limite, regras básicas",
          "Mat IV — Aplicações: máximos, mínimos, crescimento",
          "Resolver 5+ provas MEXT de Matemática — analisar erros",
        ],
      },
      physics: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Revisão geral via provas MEXT — tópicos mais cobrados",
          "Fís IV — Física Moderna: princípio da incerteza (conceitual)",
          "Lista pessoal de erros nos simulados",
        ],
      },
      chemistry: {
        priority: "alta",
        resources: ["Feltre + Coiro", "Provas MEXT"],
        notes: "",
        topics: [
          "Revisão via provas MEXT — identificar padrões",
          "Qui I — Tabela periódica aprofundada: raio, eletronegatividade",
          "Qui IV — Mecanismos de reação orgânica: SN1/SN2 (conceitual)",
          "Lista pessoal de erros nos simulados",
        ],
      },
      english: {
        ...
        notes: "",
        topics: [
          "Resolver seção inglês de 5 provas MEXT anteriores",
          "Vocabulário científico: física e química",
        ],
      },
    },
  },
  "Abr/27": {
    ...
    milestones: [
      ...
      "📊 Simulado completo MEXT cronometrado",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Provas MEXT", "Anki", "Tutor se possível"],
        notes:
          "⚠️ Inscrições MEXT costumam abrir em abril/maio. Verifique a Embaixada do Japão.",
        topics: [
          "Simulados semanais cronometrados — condições reais",
          "Revisão e análise de cada erro",
          "Redação: 自己紹介 e 志望動機 em japonês",
          "Frases para entrevista em japonês",
          "Kanji N4: 250 kanji completados",
          "Vocabulário N4: 900 palavras acumuladas",
        ],
      },
      math: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Simulados semanais MEXT de Matemática (cronometrado)",
          "Revisão focada nos tipos de questão que você mais erra",
          "Verificar edital: tópicos para sua área de interesse",
          "Nenhum tópico novo — apenas consolidação",
        ],
      },
      physics: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Simulados semanais MEXT de Física (cronometrado)",
          "Revisão direcionada pelos erros",
          "Verificar edital: tópicos específicos",
        ],
      },
      chemistry: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Simulados semanais MEXT de Química (cronometrado)",
          "Revisão direcionada pelos erros",
          "Consolidação final: Qui I-IV",
        ],
      },
    },
  },
  "Mai/27": {
    phase: "sprint",
    milestones: [
      "📋 Prazo final de inscrição MEXT (confirmar)",
    ...
    subjects: {
      japanese: {
        ...
        notes: "Sprint final. Nada de novo — consolide o que sabe.",
        topics: [
          "Intensificação: 1h30 matinal + 30 min à noite",
          "Resolver TODAS as provas MEXT de japonês disponíveis",
          "Revisão intensiva de gramática N4 — erros recorrentes",
          "2 artigos NHK Web Easy por dia",
          "Lista pessoal de erros: revisar diariamente",
        ],
      },
      math: {
        priority: "alta",
        resources: ["Provas MEXT", "Suas anotações"],
        notes: "Não tente aprender nada novo.",
        topics: [
          "Resolver + revisar todas as provas MEXT de Mat disponíveis",
          "Criar folha de referência pessoal por frente (Mat I-V)",
          "Focar no que você erra, não no que já sabe",
        ],
      },
      physics: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Resolver + revisar todas as provas MEXT de Fís disponíveis",
          "Folha de referência: fórmulas e constantes (Fís I-IV)",
        ],
      },
      chemistry: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Resolver + revisar todas as provas MEXT de Qui disponíveis",
          "Folha de referência por frente: Qui I-IV",
  ...
  "Jun/27": {
    phase: "sprint",
    milestones: [
      "🎯 PROVA MEXT — data a confirmar (costuma ser junho/julho)",
      "⚠️ Semana da prova: descanso estratégico, nada novo",
    ],
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Material já conhecido", "Suas anotações"],
        notes: "Na semana da prova: descanso é tão importante quanto estudo.",
        topics: [
          "Revisão leve: 1h matinal (reduzir da intensificação)",
          "Escuta passiva para manter ritmo auditivo",
          "Reler resumos pessoais de gramática N4",
          "Semana da prova: apenas flashcards e escuta",
        ],
      },
      math: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Revisão leve: 1 exercício/dia até 3 dias antes",
          "Ler folha de referência pessoal por frente",
          "Descanso completo nos 2 dias anteriores à prova",
        ],
      },
      physics: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Revisão leve: Fís I-IV — conceitos e fórmulas",
          "Descanso antes da prova",
        ],
      },
      chemistry: {
        priority: "alta",
        ...
        notes: "",
        topics: [
          "Revisão leve: Qui I-IV — tabela e reações essenciais",
          "Descanso antes da prova",
        ],
      },
    },
  ...
  "Jul/27": {
    ...
    subjects: {
      japanese: {
        priority: "crítica",
        resources: ["Suas anotações", "Tutor se possível"],
        notes: "A entrevista pode ser em japonês e/ou inglês. Prepare os dois.",
        topics: [
          "志望動機 e 自己紹介 em voz alta diariamente",
          "Vocabulário técnico da área de interesse em japonês",
          "Apresentação pessoal formal: praticar até fluir",
        ],
      },
      english: {
        priority: "média",
        ...
        notes: "",
        topics: [
          "Respostas de entrevista em inglês",
          "Statement of purpose: objetivos acadêmicos",
        ],
      },
    },
  },
          ...
          return (
            <button
              ...
              style={{
                ...
                padding: "6px 10px",
                borderRadius: 10,
                border: `1.5px solid ${sel ? pc : allDone ? "#86efac" : "#e2e8f0"}`,
          ...
          >
            ...
            {["😣", "😐", "🙂", "😄"].map((em, i) => (
              <button
                ...
                style={{
                  fontSize: 18,
                  border: `2px solid ${state.rating === i ? subj.color : "transparent"}`,
                  borderRadius: 8,
                  padding: "2px 4px",
                  cursor: "pointer",
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      flexShrink: 0,
                      cursor: "pointer",
                      border: `2px solid ${isDone ? cfg.color : "#d1d5db"}`,
